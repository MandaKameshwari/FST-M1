...
SELECT * from orders  
Where salesman_id= (Select distinct salesman_id from customers);
...
SELECT * from orders  
Where salesman_id= (Select distinct salesman_id from customers where customer_id=3001);
...
SELECT * from orders  
Where salesman_id= (Select distinct salesman_id from customers where customer_id=3002);
